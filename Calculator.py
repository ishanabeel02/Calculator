...
e = Entry(width=50, borderwidth=5, font=('Arial', 15))
...
def equal():
    ...
    try:
        ...
        e.insert(0, '┗|｀O′|┛ Error')
btn_style = {'pady':10, 'padx':10, 'width':10}
...
button_clear = Button(root, text='Clear', pady=10, padx=10, command=clear_button, width=25)
button_equal = Button(root, text='=', pady=10, padx=10, command=equal, width=25)
