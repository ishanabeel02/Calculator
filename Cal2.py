...
button_add = Button(root, text='+', command=lambda:get_operator('+'), **btn_style)
button_sub = Button(root, text='-', command=lambda:get_operator('-'), **btn_style)
button_div = Button(root, text='÷', command=lambda:get_operator('/'), **btn_style)
button_mul = Button(root, text='x', command=lambda:get_operator('*'), **btn_style)
